...
<html:form action="/save/student">
	...
	<logic:equal name="StudentForm" scope="request"
						property="action" value="delete">
		<bean:message key="prompt.student.delete.comfirm"
									arg0="<%=(String)request.getAttribute("name") %>"
									arg1="<%=(String)request.getAttribute("firstname") %>"
									arg2="<%=(String)request.getAttribute("birthday") %>"/>
